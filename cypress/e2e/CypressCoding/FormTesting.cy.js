describe('Day 4 Assignment - Form Testing', () => {  
  ...
  it('should add a review to a product', () => {
    ...
    cy.get('#name')
    .type('Jonathan Schneider')
    cy.get('#email')
    .type('jona@than.com')
    cy.get('#review')
    .type('This Product is awesome! Its really cheap and the quality is insanely good. There is no Shipping Cost and it came in 1 day. Nice! 5 Stars :)')
