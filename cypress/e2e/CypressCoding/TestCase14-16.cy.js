describe('TestCases', () => {
  it('RegisterWhileCheckout', () => {
    ...
    .click()
    cy.get('.btn.btn-default.check_out').should('contain',"Proceed To Checkout")
    .click()
    cy.get('u').contains('Register / Login')
    .click()
    ...
    .click()
    cy.get('#address_delivery').should('contain',"Mr. Jonathan Schneider")
    .and('contain',"Regenburg")
    .and('contain',"Koenigsforst 3")
    .and('contain',"Australia")
    .and('contain',"519285918571")
    cy.get('[name="message"]')
    .type('Pls deliver trough DHL and NOT by UPS')
